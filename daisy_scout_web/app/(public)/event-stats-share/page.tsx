...
import { EventDataShare2025 } from './2025/event-share-data-2025';
...
export default function EventSharePage() {
  ...
  const renderMatchForEvent = () => {
    switch (settings.season) {
      case '2025':
        return <EventDataShare2025 eventId={settings.getEventId()} />;
      //case '2024':
